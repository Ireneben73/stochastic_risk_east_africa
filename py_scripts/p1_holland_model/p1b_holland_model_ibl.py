# -*- coding: utf-8 -*-
"""
Created on Fri Mar 29 10:57:15 2019
@authors:   Nadia Bloemendaal  & Job Dullaart
...
## PARAMETRIC WIND MODEL OF HOLLAND: FUNCTIONS
def Generate_Spyderweb_mesh(n_cols,n_rows,tc_radius,lat0):
    ...
    rlist,thetalist=np.meshgrid(np.linspace((tc_radius/n_rows),tc_radius,n_rows),np.linspace(0,2.*np.pi,(n_cols+1))[:-1])
    #if lat0<0:
...
def Holland_model(lat0,P,Usurf,Rmax,r):#B,r):
    """
    ...
    f=abs(2.*omega*sin(radians(lat0))) #Coriolis parameter
